    ...
    getUserDetails() {
        ...
        this.appService.getUserInfo(id).subscribe(
            data => {
                ...
                this.snackBar.open(`some error occured`, 'Abort', {
                    duration: 5000,
                });
        ...
        this.appService.getUserFriends(this.userInfo.friends).subscribe(
            data => {
                ...
                if (response.status === 200) {
                    ...
                    this.snackBar.open(`${response.message}`, 'Abort', {
                        duration: 5000,
                    });
        ...
        this.appService.unFriend(this.userInfo.userId, this.id).subscribe(
            data => {
                ...
                if (data['status'] === 200) {
                    ...
                    this.snackBar.open(`Friend has been removed from your friend's list`, 'Abort', {
                        duration: 5000,
                    });
                    ...
                    let notifyObject = {
                        ...
                        message: `${this.name} has removed you from there friend list.`,
                        createdOn: new Date()
                    }
                    ...
                    this.snackBar.open(`Some error occured in removing friend from friend's list`, 'Abort', {
                        duration: 5000,
                    });
